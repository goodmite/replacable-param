...
export const Encoder = {
  ...
  htmlEncode: function (r, e) {
    var str = this.isEmpty(r)
      ? ""
      : ((e = e || !1) &&
          (r =
            "numerical" == this.EncodeType
              ? r.replace(/&/g, "&#38;")
              : r.replace(/&/g, "&amp;")),
        (r = this.XSSEncode(r, !1)),
        ("numerical" != this.EncodeType && e) || (r = this.HTML2Numerical(r)),
        (r = this.numEncode(r)),
        e ||
          ((r = r.replace(/&#/g, "##AMPHASH##")),
          (r = (r =
            "numerical" == this.EncodeType
              ? r.replace(/&/g, "&#38;")
              : r.replace(/&/g, "&amp;")).replace(/##AMPHASH##/g, "&#"))),
        (r = r.replace(/&#\d*([^\d;]|$)/g, "$1")),
        e || (r = this.correctEncoding(r)),
        "entity" == this.EncodeType && (r = this.NumericalToHTML(r)),
        r);
    var re = /&#(\d+);|([^])/g;
    var match;
    var charCodes = [];
