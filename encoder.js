...
export const Encoder = {
    EncodeType: "entity",
    isEmpty: function (r) {
        return !r || (null === r || 0 == r.length || /^\s+$/.test(r))
    },
    ...
    numEncode: function (r) {
        ...
        for (var e = [], a = r.length, i = 0; i < a; i++) {
            var t = r.charAt(i);
            if(t < " " || t > "~"){
                e.push("&#");
                e.push(t.charCodeAt());
    ...
    XSSEncode: function (r, e) {
        return this.isEmpty(r) ? "" : r = (e = e || !0) ? (r = (r = (r = r.replace(/\'/g, "&#39;")).replace(/\"/g, "&quot;")).replace(/</g, "&lt;")).replace(/>/g, "&gt;") : (r = (r = (r = r.replace(/\'/g, "&#39;")).replace(/\"/g, "&#34;")).replace(/</g, "&#60;")).replace(/>/g, "&#62;")
    },
    ...
    swapArrayVals: function (r, e, a) {
        ...
        if (e && a && e.length == a.length)
            for (var t = 0, c = e.length; t < c; t++) i = new RegExp(e[t], "g"), r = r.replace(i, a[t]);
        return r
    }
};